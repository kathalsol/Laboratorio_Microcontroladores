...
/* 
    ...
    Proyecto Final
    Estudiantes: 
        -Katharina Alfaro Solis B80251
        -Mauricio Rodriguez Obando B96694
 */


#include <Kathy29-project-1_inferencing.h>
        ...
        ei_printf("Predictions (DSP: %d ms., Classification: %d ms., Anomaly: %d ms.): \n",
              ...
              const char* winner_label = result.classification[winner].label;
                ...
                if (strcmp(winner_label, "Naranita") == 0) {
                    ei_printf("\nNaranita!!!\n");
                    myservo.writeMicroseconds(2000);   // Pone las Naranitas hacia un lado
                    delay(2000);
                    myservo.write(90);
                }
                ...
                if (strcmp(winner_label, "Cereal") == 0) {
                    ei_printf("\nCereal!!!\n");
                    myservo.writeMicroseconds(1000);   // Pone el Cereal hacia el otro lado
                    delay(2000);
                    myservo.write(90);
                }

                if (strcmp(winner_label, "Ninguno") == 0) {
                    ei_printf("\nNinguno!!!\n");
                    myservo.write(90);
                }
